...
<div class="row">
                    <div class="col-12"> 
                          <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page"><i class="feather-upload-cloud ml-1 " style="letter-spacing: 5px;"></i>Item List</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 ">
                        <div class="card fullc mb-4 p-3">
                            <div class="card body">
                                <div class="d-flex justify-content-between align-items-center">
                           <div class="d-flex justify-content-center align-items-center">
                                 <i class="feather-list text-primary mr-1" style="font-size: 25px;"></i>  <h4 class="mb-0"> Item List</h4>
                            </div>
                                    <div>
                                        <a href="#" class="btn btn-outline-secondary full-screen-btn"><i class="feather-maximize-2 "></i></a>
                                    <a href="<?php echo $url ?>/add_item.php" class="btn btn-outline-primary"><i class="feather-plus-circle"></i></a>
                                    </div>

                                </div>
                                <hr>
                                <table id="list" class="table table-striped table-hover" class="display" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th>Position</th>
